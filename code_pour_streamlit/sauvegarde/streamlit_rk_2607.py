...
"""
    ...
    menus = ["Accueil","Introduction", "Exploration des données", "Modélisation", "Conclusion" ]
    ...
    if choice == "Accueil":
        ...
        with st.spinner('Updating Report...'):
            ...
            st.write("- Nombre de colonnes :  11")
        ...
        with row5_spacer1:    
            ...
            st.write("- 'reponse' : réponse apportée par la compagnie")
            st.write("- 'ville' ")
        with row5_spacer2:  
            st.write("- 'maj' : mise à jour des informations ")
            st.write("- 'date_commande' ")
            st.write("- 'ecart' : durée entre la date de passage de la commande et la date de reception du produit")
        st.markdown("-----------------------------")   
