...
"""
    ...
    menus = ["Accueil", "Exploration des données", "Modélisation", "Conclusion" ]
    ...
    if choice == "Accueil":
        ...
        with row3_1:
            st.header("APPLICATION POUR L'ANALYSE DE SENTIMENTS DE COMMENTAIRES CLIENTS")
        ...
        with st.spinner('Updating Report...'):
            ...
            st.write("- Nombre de valeurs manquantes :  82653 dont 27 pour la colonne Commentaire")
            st.write("- Nombre de variables numériques :  2")
            st.write("- Nombre de variables object :  9")
...
#graph binaire           
        ...
        fig = px.bar(x, template = 'seaborn', color = x , color_discrete_sequence = ["orange","brown", "green", "darkslateblue",'grey'], color_continuous_scale=px.colors.diverging.Earth)
...
#########
    ...
    #####################################################################
        if option == 'APPROCHES PROPOSEES' :    
            ...
            with row4_1:        
                ...
                st.image(image)
         ####################################################################
            explication_modèles = st.expander('Schéma des modèles de plongement de dimension 👉🏼 ')
            with explication_modèles:
                ...
                with row:
                    st.write("Doc2Vec Paragraph Vector - Distributed Bag of words")
                    image = Image.open(r"C:/Users/kevin/0_projet_satisfaction_client/10_Streamlit/PV-DBOW.png")
                    st.image(image)
                    
                with row4_spacer2:
                    st.write("Doc2Vec Paragraph Vector - Distributed Memory Model")
        ...
        if option == "MEILLEURS MODELES" :  
            ...
            with row5_1:
                ...
                st.markdown("- Commentaires considérés dans leur entièreté")
                st.markdown("- Vectorisation TF-TDF / BOW générant uniquement des unigrammes")
                ...
                st.markdown("- Equilibre entre F1-score de la classe positive et F1-score de la classe")
                st.markdown("---")
                st.markdown(" ")
        ...
        if option == "MODELE RETENU POUR LA MISE EN PRODUCTION" :  
            st.subheader("TF-IDF - Regression Logistique")
    ...
    ################################################ Demonstration
         ...
         if option == 'PERSPECTIVES':
            ...
            st.subheader(" ")
            st.subheader("Amélioration de la supply chaine ")
